...
Syncs open, non-draft PRs to Linear issues with a 20-calendar-day SLA. Idempotent — uses a `linear-synced` label and Linear attachments to avoid duplicates across runs.
